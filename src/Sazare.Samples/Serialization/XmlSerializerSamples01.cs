namespace Sazare.Samples
{
  ...
  public class XmlSerializerSamples01_Data
  {
    ...
    /// カスタムオブジェクト
    /// </summary>
    public XmlSerializerSamples01_Data2 ObjectProperty
    {
      get;
      set;
    }
    ...
    public List<XmlSerializerSamples01_Data2> ListProperty
    {
      get;
      set;
    }
    ...
    /// </summary>
    //public Dictionary<int, XmlSerializerSamples01_Data2> DictionaryProperty
    //{
    //  get;
    //  set;
    //}
    ...
    /// 列挙型
    /// </summary>
    public XmlSerializerSamples01_Enum EnumProperty
    {
      get;
      set;
    }
